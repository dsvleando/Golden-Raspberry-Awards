...
class MovieUpdateIT {
    ...
    void shouldUpdateMovieWithAllFields() {
        ...
        assertThat(producerJpaRepository.count()).isEqualTo(302L); 
    ...
    void shouldUpdateMovieWithMultipleProducersAndStudios() {
        ...
        assertThat(updatedMovie.getStudios()).extracting(Studio::getName)
                .containsExactlyInAnyOrder("Test Studio B", "Test Studio C");
        ...
        assertThat(movieJpaRepository.count()).isEqualTo(207L);
        assertThat(producerJpaRepository.count()).isEqualTo(303L);
    ...
    void shouldUpdateMovieRemovingAllProducersAndStudios() {
        ...
        assertThat(producerJpaRepository.count()).isEqualTo(301L);
